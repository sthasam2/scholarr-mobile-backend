...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "https://scholarr-mobile-backend.herokuapp.com/",
]
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql_psycopg2",
        "NAME": get_environ_variable("HPSQL_NAME"),
        "USER": get_environ_variable("HPSQL_USER"),
        "PASSWORD": get_environ_variable("HPSQL_PASSWORD"),
        "HOST": get_environ_variable("HPSQL_HOST"),
        "PORT": "",
    }
}
